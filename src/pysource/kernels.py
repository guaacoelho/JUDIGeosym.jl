...
def wave_kernel(model, u, fw=True, q=None, f0=0.015, par="vp-vs-rho"):
    """
    ...
    if model.is_tti:
        ...
        pde = elastic_kernel(model, u[0], u[1], fw=fw, par=par)
    else:
...
def elastic_kernel(model, v, tau, fw=True, par="vp-vs-rho"):
    """
